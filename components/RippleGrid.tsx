...
void main() {
    ...
    // SLOWED DOWN: The pulse speed is now much slower in the shader logic effectively
    // But we control time passed in JS mostly.
    ...
    const render = (t: number) => {
      ...
      // SIGNIFICANTLY REDUCED SPEED (0.0002 instead of 0.001)
      // This makes the background "breathe" very slowly rather than pulse rapidly
      uniforms.iTime.value = t * 0.0002;
